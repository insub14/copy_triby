        ...
        <div id="body1">
            ...
            <div id="leftNright">
                <div id="left">
                    ...
                    <!-- 트리비 포함사항 -->
                    <div class="triby_left" id="triby_position2">
                        <div class="intro_title">포함사항</div>
                        <div id="triby">
                            <div id="position_text">
                                <p><%=dt.get(0).gettContent1() %> </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- 트리비 세부일정-->
                    <div class="triby_left" id="triby_position2">
                        <div class="intro_title">세부일정</div>
                        <div id="triby">
                            <div id="position_text">
                                <p><%=dt.get(0).gettContent2() %> </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- 트리비 준비물-->
                    <div class="triby_left" id="triby_position2">
                        <div class="intro_title">준비물</div>
                        <div id="triby">
                            <div id="position_text">
                                <p><%=dt.get(0).gettContent3() %> </p>
                            </div>
                        </div>
                    </div>
